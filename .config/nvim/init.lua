...
vim.keymap.set('n', '<C-x>', 'gqip', { desc = 'format current paragraph' })
...
require('lazy').setup({
...

  {
    ...
    opts = {
      ...
      -- so the id of notes doesn't turn into unreadable bullshit
      ...
      callout = {
        ...
        quote = { raw = '[!QUOTE]', rendered = '󱆨 ', highlight = 'RenderMarkdownQuote', category = 'obsidian' },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<S-f>', builtin.live_grep, { desc = 'Find File by Grep' })
      ...
      vim.keymap.set('n', '<leader>dq', function()
        ...
        require('dapui').close()
        require('nvim-dap-virtual-context').toggle()
      end, { desc = 'Terminate' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'rust', 'zig' },
...
vim.keymap.set('n', '<C-c>', ':vert:Compile ', { desc = 'Compile command like Emacs' })
